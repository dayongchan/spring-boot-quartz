...
public class JobDefinition implements Serializable {
    ...
    public JobDefinition(String jobName, String jobGroup) {
        super();
        this.jobName = jobName;
        this.jobGroup = jobGroup;
    }

    public JobDefinition(String jobName, String jobGroup, String jobStatus, String isConcurrent,
    ...
    public String toString() {
        ...
        sb.append("JobDefinition [jobId=").append(jobId).append(", jobName=").append(jobName)
    ...
    public boolean equals(Object obj) {
        ...
        JobDefinition oBean = (JobDefinition) obj;
